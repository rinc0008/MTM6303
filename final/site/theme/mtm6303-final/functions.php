...
function mtm6303final_setup() {
    ...
    //Add enqueue script
    wp_enqueue_script( 'jquery', get_theme_file_uri( 'assets/js/jquery.js' ), '', '1.0.0', true );

   /*
   * NO parallax doc in this theme, kept as a template with array
...
/**
 *  Get the nav bar and pages from dashboard wordpress with styles
 * */ 
